...
Note that in Go, a Unicode code point is typically called a "**rune**". (Go [seems to have](https://go.dev/blog/strings#code-points-characters-and-runes) introduced the term for the sake of brevity[^origin-of-rune]. I certainly appreciate that, but I'm going to stick with universal terms here.)

[^origin-of-rune]: After reading this post, Connor Taffe took a [deep dive](https://connor.zip/posts/2025-05-03-rune) into the origins of "rune" (and UTF-8). [Code archeology](https://en.wikipedia.org/wiki/A_Deepness_in_the_Sky#Interstellar_culture) is cool.
