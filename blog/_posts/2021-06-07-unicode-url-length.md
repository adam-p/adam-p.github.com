...
I found that passing 2020 or fewer bytes was fine, but passing 2022 or more bytes would trigger that error. But passing exactly 2021 bytes... was even worse. It would open a browser tab with a URL that started like <code style="white-space:initial">res://ieframe.dll/unknownprotocol.htm#psi:psicash?%7B%22command%22%3A%22login%22%2C%22id%22%3A%22MC4yOTc5MjI5MTY4ODU3MjI4%22%2C%22password%22%3A%2201234567890...</code>. And there's the user's password in the browser address bar! (We'll call this the ">2020 error".)
